	...
	<div class="wrapper">
	    <nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="Reviewer_Dashboard.php">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						<a class="sidebar-link" href=" Reviewer_Dashboard.php">
              			<i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
           				</a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="reviewer-profile.php">
              			<i class="align-middle" data-feather="user"></i> <span class="align-middle">Profile</span>
						</a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="following.php">
              			<i class="align-middle" data-feather="users"></i> <span class="align-middle">Following Authors</span>
						</a>
					</li>
					...
					<ul class="navbar-nav navbar-align">
						...
						<li class="nav-item">
							<a class="nav-link d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
								<img src="assets/img/avatar_user.jpg " class="avatar img-fluid rounded-circle me-1" alt="" /> <span class="text-dark">
									...
									<div class="col-sm-6">
										...
										<div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title">Followers Count</h5>
													</div>
									...
									<div class="col-sm-6">
										...
										<div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title">Followings Count</h5>
													</div>
