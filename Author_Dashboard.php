										...
										<div class="card">
											<div class="card-body">
												...
												<?php 
                                                    ...
                                                    $author_id = $_SESSION['email'];
                                                    
                                                    $submission_query = "SELECT COUNT(article_id) as count
                                                                        FROM article_info
                                                                        WHERE email = '$author_id'";
                                                    $submission_count = ($conn->query($submission_query))->fetch_assoc();
                                                    
                                                    $count = $submission_count['count'];
                                                    $conn->close();
                                                    
												    echo '<h1 class="mt-1 mb-3">'.$count.'</h1>';?>
												<div class="mb-0">
