        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <div class="member-info">
                <h4>Rasadun Sayurumeth</h4>
                <span>Univercity Student</span>
                <p></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <div class="member-info">
                <h4>Harindu Hadithya</h4>
                <span>Univercity Applicant</span>
                <p></p>
              </div>
            </div>
          </div>
