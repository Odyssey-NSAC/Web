			...
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active ">
						<a class="sidebar-link" href="self_eval.php">
              			<i class="align-middle" data-feather="bar-chart-2"></i> <span class="align-middle">Self Evaluation</span>
            			</a>
					</li>
					<li class="sidebar-item">
						...
						<div class="col-sm" style="margin-left: 25%;">
							<div class="card" style="width: 30rem;">
								<div class="card-header">
									<h5 class="card-title mb-0">Self Evaluation Form</h5>
								</div>
								<div class="card-body">
								    <form action="self_disconnect.php" method='post'>
								         <?php 
                                            ...
                                            $questions_sql = "SELECT*FROM questionnaires
                                                              WHERE feedback_type='self' AND activity='$activity'";
